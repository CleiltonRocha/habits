            ...
            {habitsInfo?.possibleHabits.map(habit => {
                ...
                return(
                    ...
                    >
                        ...
                        <span className="font-semibold text-xl text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-700 transition ease-in">
                            {habit.title}
                        </span>
                    </Checkbox.Root>
